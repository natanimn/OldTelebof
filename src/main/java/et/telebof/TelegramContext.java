...
public class TelegramContext {
    ...
    private final StateMemoryStorage memoryStorage;

    public TelegramContext(Update update, RequestSender requestSender, ParseMode parseMode, StateMemoryStorage memoryStorage){
        this.update = update;
    ...
    public TelegramContext(RequestSender requestSender, ParseMode parseMode, StateMemoryStorage memoryStorage){
